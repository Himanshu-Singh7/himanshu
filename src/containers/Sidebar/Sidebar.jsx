...
const Sidebar = ({ showMenu, toggleMenu }) => {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-start p-10  pt-1 bg-black text-white w-10 h-full">
        <button
          onClick={toggleMenu}
        ...
        <div className="flex flex-col items-center justify-center space-y-3 mt-120 fixed">
          <a
            href="https://github.com/Himanshu-Singh7"
            className="icon"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/himanshu-singh9/"
            className="icon"
            target="_blank"
          >
